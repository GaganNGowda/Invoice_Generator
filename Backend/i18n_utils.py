...
TRANSLATIONS = {
    ...
    "kn": {
        ...
        "ask_salutation": "ಅವರ ಗೌರವ (ಶ್ರೀ/ಶ್ರೀಮತಿ/ಡಾ.) ಏನು?",
        ...
        "item_prices_adjusted_proceed_custom_fields": "ಐಟಂ ಬೆಲೆಗಳನ್ನು ಒಟ್ಟು **{provided_total:.2f}** ಗೆ ಹೊಂದಿಸಲಾಗಿದೆ. ಕಸ್ಟಮ್ ಫೀಲ್ಡ್‌ಗಳಿಗೆ ಮುಂದುವರಿಯಲಾಗುತ್ತಿದೆ. ಕಸ್ಟಮ್ ಫೀಲ್ಡ್‌ಗಾಗಿ ನಗರ ಯಾವುದು?",
